        ...
        this.description = {
            ...
            properties: [
                ...
                },
                {
                    ...
                    name: 'userAgent',
                    type: 'string',
                    default: "Mozilla/5.0 (iPhone; CPU iPhone OS 17_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.0 Mobile/15E148 Safari/604.1",
                },
            ],
        };
    }
        ...
        for (let itemIndex = 0; itemIndex < items.length; itemIndex++) {
            ...
            if (!videoId) {
                ...
                try {
                    ...
                    const finalUrl = Array.isArray(location) ? location[0] : location;
                    if (finalUrl) {
            ...
            const videoInfoRes = loaderData?.[VIDEO_ID_PAGE_KEY]?.videoInfoRes || loaderData?.[NOTE_ID_PAGE_KEY]?.videoInfoRes;
...
exports.DouyinParse = DouyinParse;
