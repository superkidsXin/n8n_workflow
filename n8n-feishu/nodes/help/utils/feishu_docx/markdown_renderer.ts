...
import {escapeHTMLTags, Renderer, trimLastNewline} from './renderer';
import {Buffer} from './string_buffer';
import {Block, BlockType, CodeLanguage, DocMetaInfo, getAlignStyle, getCodeLanguage, ImageBlock, TableBlock, TableMergeInfo, TextBlock, TextElement, TextRun} from './types';
...
export class MarkdownRenderer extends Renderer {
  ...
  parseGrid(block: Block) {
    ...
    buf.writeln(`<div class="flex gap-3 columns-${column_size}" column-size="${
        column_size}">`);
