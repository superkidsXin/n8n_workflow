...
export interface TableBlock {
  cells: string[];
  property: {
    row_size: number; column_size: number; column_width: number[];
...
export interface DocInfo {
  ...
  revision_id: string;
  title: string;
  cover: {token: string; offset_ratio_x: number; offset_ratio_y: number;};
  display_setting: {
    show_authors: boolean; show_create_time: boolean;
