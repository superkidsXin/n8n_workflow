...
const options: INodeProperties[] = [
  ...
  },
  {
    ...
    default: '',
    description:
        'Optional full object key. If empty, uses prefix + original file name.',
  },
  {
...
async function call(
  ...
  const objectKeyParam =
      this.getNodeParameter('objectKey', itemIndex) as string;
  ...
  if (!bin) {
    throw new NodeOperationError(
        this.getNode(), `Binary property "${binaryProperty}" is missing`,
        {itemIndex});
  }
